...
config_1.subtask("hardhat-solpp:run-solpp", async ({ files, opts }, { config }) => {
...
config_1.subtask(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS, async (_, { config, run }, runSuper) => {
